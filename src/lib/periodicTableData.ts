...
export const periodicTableData: ElementData[] = [
  ...
  { atomicNumber: 22, symbol: "Ti", name: "Titanium", group: 4, period: 4, commonOxide: "TiO2", atomicWeight: 47.87, category: "transition-metal" },
  { atomicNumber: 23, symbol: "V", name: "Vanadium", group: 5, period: 4, commonOxide: "V2O5", atomicWeight: 50.94, category: "transition-metal" },
  { atomicNumber: 24, symbol: "Cr", name: "Chromium", group: 6, period: 4, commonOxide: "Cr2O3", atomicWeight: 52.00, category: "transition-metal" },
  { atomicNumber: 25, symbol: "Mn", name: "Manganese", group: 7, period: 4, commonOxide: "MnO", atomicWeight: 54.94, category: "transition-metal" },
  { atomicNumber: 26, symbol: "Fe", name: "Iron", group: 8, period: 4, commonOxide: "FeO", atomicWeight: 55.85, category: "transition-metal" },
